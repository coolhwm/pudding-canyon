...
function loadLevel2(){
  LEVEL_W = 4600;
  platforms.push({ x:0, y:GROUND, w:520, h:80, kind:"dirt" });
  platforms.push({ x:520, y:GROUND, w:180, h:80, kind:"dirt", vanish:true, safe:false, vanished:false });
  platforms.push({ x:800, y:GROUND, w:280, h:80, kind:"dirt" });
  jelly = { x:1080, y:452, w:100, h:88 };
  platforms.push({ x:1180, y:GROUND, w:500, h:80, kind:"dirt" });
  fakeFlag = { x:1390, y:370, w:36, h:90 };
  ghostBridge = { x:1680, y:GROUND, w:150, h:22 };
  platforms.push({ x:1830, y:GROUND, w:270, h:80, kind:"dirt" });
  platforms.push({ x:2100, y:GROUND, w:200, h:80, kind:"dirt", iceSurprise:true, safe:false });
  platforms.push({ x:2440, y:GROUND, w:1380, h:80, kind:"dirt" });
  yarnBall = { x:2580, y:432, r:28 };
  spikeRug = { x:2760, y:GROUND - 6, w:120, h:10 };
  decoCakes.push({ x:940, y:GROUND, trap:false });
  decoBushes.push({ x:1560, y:GROUND });
  decoCakes.push({ x:3140, y:GROUND, trap:true });
  surpriseVac = { x:3140, y:390, w:70, h:70 };
  pieZone = { x:3380, w:240 };
  sheep = { x:3720, y:GROUND - 44, w:64, h:48, vx:0 };
  windZone = { x:3700, w:260 };
  platforms.push({ x:3960, y:GROUND, w:640, h:80, kind:"dirt" });
  decoCakes.push({ x:4100, y:GROUND, trap:false });
  realGoal = { x:4420, y:GROUND - 28, w:64, h:36 };
